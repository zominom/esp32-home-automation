...
private:
    ...
    const bool get_characteristic_handle(const std::string& address, const std::string& service_uuid, const std::string& characteristic_uuid);
    const bool send_command(const String& command);
    void delete_client();
